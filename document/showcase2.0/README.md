...
第一次了解项目，先阅读[产品概览](01-datapath-product-overview.md)，再查看[产品页面截图](07-product-page-gallery.md)，了解完整产品链路和实际界面。最后阅读[竞品研究与产品决策](06-competitive-research-and-product-decisions.md)，了解项目为什么将重点放在受约束问数、AI 语义预热和持续质量闭环。
